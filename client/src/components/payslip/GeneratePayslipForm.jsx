...
const GeneratePayslipForm = ({ employees, onSuccess }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            toast.error("Failed to generate payslip. Please try again later.");
        }
        setLoading(false);
    }
                ...
                <form onSubmit={handleSubmit} className='space-y-4'>
                    ...
                    <div className='grid grid-cols-2 gap-4'>
                        <div>
                            ...
                            <input type="number" name="allowances" required placeholder='0' />
                        </div>
                        <div>
                            <label className='block text-sm font-medium text-slate-700 mb-2'>Deductions</label>
                            <input type="number" name="deductions" required placeholder='0' />
                        </div>
                    </div>
