      ...
      <div className="w-full md:w-1/2 flex flex-col items-center justify-center p-6 sm:p-12 lg:p-16 relative overflow-y-auto min-h-screen">
        ...
        <div className="w-full max-w-md animate-fade-in relative z-10">
          ...
          <div>
            ...
            <p className="text-slate-500">Select your portal to securely access the portal</p>
          </div>
          ...
          <div className="space-y-4">
            {portalOptions.map((portal) => (
              ...
              >
                <div className="flex items-center relative z-10 justify-between gap-4 sm:gap-5">
          ...
          {/* Footer */}
          <div className="mt-12 text-center text-sm md:text-left text-slate-400">
            <p>&copy; 2026 QuickEMS-Employee Management System. All rights reserved.</p>
          </div>
